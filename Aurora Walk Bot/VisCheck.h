...
public:
    ...
    bool IsPointVisible(const Vector3g& point1, const Vector3g& point2);
    bool RayIntersectsTriangle(const Vector3g& rayOrigin, const Vector3g& rayDir,
...
private:
    ...
    bool IntersectBVH(const BVHNode* node, const Vector3g& rayOrigin, const Vector3g& rayDir, float maxDistance, float& hitDistance);
};
