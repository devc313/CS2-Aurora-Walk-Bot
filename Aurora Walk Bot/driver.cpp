...
HANDLE mem::driver_handle = nullptr;
INT32 mem::process_id = 0;

bool mem::find_driver() {
	driver_handle = CreateFileW((L"\\\\.\\\ituffdriver"), GENERIC_READ | GENERIC_WRITE, FILE_SHARE_READ | FILE_SHARE_WRITE, NULL, OPEN_EXISTING, 0, NULL);
